...
{
  int32_t M;
  int32_t K; // limit: must be aligned with 32byte
  int32_t N; // limit: must be aligned with 16byte

  // matmul data type, only support int8 currently
...
/* rknn_matmul_set_io_mem
    ...
    limit:
      K <= 4096
      K align with 32bytes
      N align with 16bytes
